...
PLAYBOOKS: dict[str, dict[str, Any]] = {
    ...
    "n_pattern_long_wash": {
        "title": "长洗N字回踩",
        "subtitle": "研究验证 · 大阳启动后长时间缩量洗盘，守住启动低点再放量修复",
        "logic": "先识别涨停/大阳启动，再观察 7-15 日缩量回落是否始终守住启动日低点；只有重新放量中阳或连续小阳爬升时才纳入观察。",
        "notes": [
            "当前定位为研究策略，不进入生产强买和自动交易。",
            "核心防守位是启动日低点，跌破即判定 N 字结构失败。",
            "洗盘越久越要看量能是否干净收缩，重新放量修复才算右侧确认。",
        ],
    },
    "n_pattern_short_wash": {
        "title": "短洗N字试错",
        "subtitle": "研究验证 · 启动后快速分歧，红十字/锤头线守住低点",
        "logic": "涨停或大阳启动后，2-5 日内出现放量分歧并快速缩回；若尾盘收红十字、锤头或长下影且不破启动低点，只记录小仓试错样本。",
        "notes": [
            "当前定位为高风险研究策略，只用于样本积累和回测验证。",
            "只适合尾盘小仓试错，次日不弱转强就按 T+1 纪律退出。",
