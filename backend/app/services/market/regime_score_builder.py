...
def build_state_scores(
    *,
    ...
    emotion_strength = emotion_strength_score(
        emotion_ready,
        limit_up_count,
        board_height,
        promotion_ratio,
...
def composite_distribution_pressure(
    *,
    emotion_ready: bool,
...
def select_state(state_scores: dict[str, float]) -> tuple[str, float]:
