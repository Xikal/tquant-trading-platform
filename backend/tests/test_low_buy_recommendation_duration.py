...
class LowBuyRecommendationDurationTests(unittest.TestCase):
    ...
    def test_strategy_layers_follow_24_month_backtest_decision(self) -> None:
        ...
        self.assertTrue(participates_in_priority_board("core_midcap_vwap_ma5_retrace"))
        self.assertTrue(participates_in_priority_board("sector_mainline_first_divergence_low_buy"))
        self.assertTrue(participates_in_priority_board("mainline_limitup_shrink_retrace_reclaim"))
        ...
        self.assertEqual(strategy_layer("mainline_limitup_shrink_retrace_reclaim"), "production")
