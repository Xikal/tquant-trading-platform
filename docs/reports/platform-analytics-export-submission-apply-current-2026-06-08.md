...
- 生成时间：`2026-06-08T05:16:52.264621+00:00`
- 模式：`apply`
...
| Dataset | Task | ID | Status |
| --- | --- | ---: | --- |
| strategy_tracking_snapshots | analytics_export_strategy_tracking_snapshots | 33984 | queued |
| key_level_snapshots | analytics_export_key_level_snapshots | 33985 | queued |
| low_buy_result_snapshots | analytics_export_low_buy_result_snapshots | 33986 | queued |
| backtest_runs | analytics_export_backtest_runs | 33987 | queued |
| backtest_trades | analytics_export_backtest_trades | 33988 | queued |
| backtest_daily_snapshots | analytics_export_backtest_daily_snapshots | 33989 | queued |
| analysis_logs | analytics_export_analysis_logs | 33990 | queued |
| market_review_reports | analytics_export_market_review_reports | 33991 | queued |
| paper_review_reports | analytics_export_paper_review_reports | 33992 | queued |
