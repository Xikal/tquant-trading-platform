...
| --- | --- | --- | --- | --- | --- | --- |
| default_exit | partial | 202 | 44.55% | 0.9495 | -0.0982% | -58.8845% |
| atr_stop_1p0 | partial | 202 | 43.56% | 0.8448 | -0.3358% | -70.8719% |
| force_t1_close | partial | 202 | 45.54% | 1.1893 | 0.3029% | -42.7195% |
| force_t2_close | partial | 202 | 43.56% | 1.0575 | 0.1075% | -45.9759% |
| quick_tp3_trailing1 | partial | 202 | 82.67% | 2.0085 | 0.826% | -27.1855% |
- 目标策略矩阵状态：`empty_no_evidence`，空样本/非完整覆盖不作为生产通过证据。
- 分批出场新增：`False`，默认行为未变。

批次结论：`partial_data`；生产变更允许：`False`。

## 机器产物
- JSON：`backend/data/reports/strategy-success-rate/strategy-exit-variants-2026-06-11.json`
- Markdown：`docs/reports/strategy-exit-variants-2026-06-11.md`
