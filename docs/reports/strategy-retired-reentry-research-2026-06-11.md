...
## 核心内容
- late_session：成交 `58`，walk-forward `0/7 pass`，继续低样本限权。
- N 字家族仅 observe_confirmed 研究态，不写生产 override。

批次结论：`ready`；生产变更允许：`False`。

## 机器产物
- JSON：`backend/data/reports/strategy-success-rate/strategy-retired-reentry-research-2026-06-11.json`
- Markdown：`docs/reports/strategy-retired-reentry-research-2026-06-11.md`
