...
export function PortfolioExecutionPanel({
  ...
  preview?: PaperPortfolioExecutionPreview;
  embedded?: boolean;
}) {
  const content = <PortfolioExecutionContent preview={preview} />;
...
function PortfolioExecutionContent({ preview }: { preview?: PaperPortfolioExecutionPreview }) {
