...
export function PaperMechaParticles({ state }: { state: PaperMechaVisualState }) {
    ...
    const triggerBurst = () => {
      if (state === "buy") {
        ...
        for (let index = 0; index < 6; index += 1) {
          particles.push(createParticle(
            ...
            height - 30,
            `rgba(239, 68, 68, ${Math.random() * 0.7 + 0.3})`,
            (Math.random() - 0.5) * 3,
            -Math.random() * 8 - 4,
            Math.random() * 25 + 15,
            Math.random() * 5 + 3,
      ...
      if (state === "sell") {
        if (!lanceEffect) {
          ...
          shockwaves.push(createShockwave(width / 2, height / 2, "rgb(16 185 129)", 160));
        }
        for (let index = 0; index < 5; index += 1) {
          particles.push(createParticle(
            Math.random() * width,
            Math.random() * height,
            `rgba(16, 185, 129, ${Math.random() * 0.8 + 0.2})`,
            (Math.random() - 0.5) * 6,
            (Math.random() - 0.5) * 6,
            Math.random() * 15 + 10,
            Math.random() * 3 + 1,
      ...
      if (state === "profit" || state === "auto") {
        for (let index = 0; index < 3; index += 1) {
          particles.push(createParticle(
            ...
            `rgba(245, 158, 11, ${Math.random() * 0.8 + 0.2})`,
            (Math.random() - 0.5) * 4,
            (Math.random() - 0.5) * 4,
            Math.random() * 30 + 15,
            Math.random() * 3 + 2,
      ...
      if (state === "risk") {
        ...
        particles.push(createParticle(
          ...
          `rgba(239, 68, 68, ${Math.random() * 0.7 + 0.2})`,
          (Math.random() - 0.5) * 5,
          (Math.random() - 0.5) * 5,
          Math.random() * 18 + 10,
          Math.random() * 4 + 2,
  ...
  return <canvas ref={canvasRef} className="paper-mecha-action-panel__particles" aria-hidden="true" />;
}
