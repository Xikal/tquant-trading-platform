  ...
  return (
    <div className={styles.panelBody}>
      ...
      <div className={styles.summaryGrid}>
        ...
        <InfoPill label="阻断" value={`${summary.blocked} 个`} tone={summary.blocked ? "down" : "neutral"} />
        <InfoPill label="过期" value={`${summary.stale} 个`} tone={summary.stale ? "warn" : "neutral"} />
        <InfoPill label="缺失" value={`${summary.missing} 天`} tone={summary.missing ? "warn" : "neutral"} />
      </div>
      {summary.blocked ? <Button size="small" onClick={onShowBlocked}>查看阻断数据集</Button> : null}
