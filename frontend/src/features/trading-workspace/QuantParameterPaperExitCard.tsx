...
const PAPER_EXIT_FIELDS: QuantFieldSpec[] = [
  ...
  { path: "paper.dynamic_exit.trailing_stop_trigger_pct", label: "移动止盈启动", min: 0, max: 20, step: "0.1", suffix: "%" },
  { path: "paper.dynamic_exit.trailing_stop_pct", label: "移动止盈回撤", min: 0, max: 10, step: "0.1", suffix: "%" },
  { path: "paper.dynamic_exit.trailing_stop_sell_ratio", label: "移动止盈卖出", min: 0, max: 1, step: "0.05", suffix: "比例" },
