...
import { formatMoneyPlain, formatPct, toneFromChange } from "./workspaceFormatters";
      ...
      <div className="paper-summary-main">
        ...
        <div className="paper-summary-actions">
          ...
          {account?.status === "paused" && onTogglePause ? (
            <button type="button" className="ghost-button" disabled={loading} onClick={() => void onTogglePause()}>
              恢复自动委托
            </button>
          ) : null}
        </div>
