...
function iconPath(name: LegacyNavIcon) {
  switch (name) {
    ...
    case "wallet":
      return <path d="M3 4h9.5c.6 0 1 .4 1 1v1H10c-.8 0-1.5.7-1.5 1.5S9.2 9 10 9h3.5v2.5c0 .8-.7 1.5-1.5 1.5H3c-.8 0-1.5-.7-1.5-1.5v-6C1.5 4.7 2.2 4 3 4Zm7 3c-.3 0-.5.2-.5.5s.2.5.5.5h3V7h-3Z" />;
    case "database":
